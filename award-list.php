...
// Get every class/section in the school (admin isn't limited to assigned classes)
$stmt_classes = $pdo->query("
    SELECT c.id AS class_id, c.class_name, IFNULL(s.id, 0) AS section_id, s.section_name
    FROM classes c
...
<head>
    ...
    <title>Award List | Admin Dashboard</title>
...
<body>
        ...
        <div class="content-wrapper p-4">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 no-print">
                    ...
                    <a href="view-scores.php" class="btn btn-outline-secondary fw-bold shadow-sm"><i class="fas fa-arrow-left me-1"></i> Back to Scores</a>
                </div>
                ...
                <?php if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['class_id']) && $_GET['class_id'] !== ''): ?>
    ...
    <script>
        document.getElementById('saveAllMarksBtn')?.addEventListener('click', function() {
            ...
            fetch('ajax/admin_save_award_scores.php', {
                method: 'POST',
