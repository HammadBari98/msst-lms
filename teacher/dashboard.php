...
$recent_activities = [
    ['title' => 'Graded Assignment 1 for Data Science', 'time' => '2 hours ago', 'description' => 'Submitted grades for review.'],
    ['title' => 'Updated lecture notes for AI Module', 'time' => '1 day ago', 'description' => 'Lecture 5: Neural Networks updated.'],
    ['title' => 'Scheduled extra class for Algorithms', 'time' => '3 days ago', 'description' => 'Class scheduled on Friday at 4 PM.'],
];

$upcoming_deadlines = [
    ['title' => 'Assignment 2 Submission', 'due' => 'Due in 2 days', 'description' => 'Students need to submit on LMS.', 'urgency_class' => 'text-warning'],
    ['title' => 'Midterm Exam Preparation', 'due' => 'Due in 5 days', 'description' => 'Prepare exam questions for review.', 'urgency_class' => 'text-danger'],
    ['title' => 'Parent-Teacher Meeting', 'due' => 'Next Week', 'description' => 'Meeting with parents for academic feedback.', 'urgency_class' => 'text-info'],
];

// ✅ These 3 were missing - they caused the 500 error
...
<head>
    ...
    <title><?= htmlspecialchars($teacher_name) ?> | teacher Dashboard</title>
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                            teacher ID</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= htmlspecialchars($teacher_id) ?></div>
                    </div>
                    <div class="ms-auto">
                    ...
                    <?php if (!empty($upcoming_deadlines)): ?>
                        ...
                        <a href="#" class="list-group-item list-group-item-action">
                            <div class="d-flex w-100 justify-content-between">
                                ...
                                <small class="<?= htmlspecialchars($deadline['urgency_class']) ?>">
                                    <?= htmlspecialchars($deadline['due']) ?>
                                </small>
                            </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Ensure dashboard is active by default if path is root or index
             if (currentPath === 'teacher_dashboard.php' || currentPath === '') {
                const dashboardLink = sidebar.querySelector('a[href="teacher_dashboard.php"]');
